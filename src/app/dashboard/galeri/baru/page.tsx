...
import { createGaleri } from '@/app/actions/galeri.actions'
import ImageUploader from '@/components/editor/ImageUploader'

export default function BaruGaleriPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-900 font-heading">Upload Media Galeri</h2>
          <p className="text-slate-500 text-sm mt-0.5">Tambahkan foto untuk ditampilkan di halaman galeri</p>
        </div>
      </div>
          ...
          <div className="md:col-span-3 space-y-5">
            <div className="space-y-2">
              ...
              <input
                ...
                type="text"
                required
                placeholder="Contoh: Lomba Pramuka Tingkat Kabupaten"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                name="deskripsi"
                rows={3}
                placeholder="Tulis sedikit deskripsi tentang momen ini..."
            ...
            <div className="pt-4 flex gap-4">
              ...
              >
                {isPending ? (
                  ...
                  <>
                    <Save className="w-5 h-5" /> Simpan Galeri
                  </>
                )}
              </button>
            </div>
