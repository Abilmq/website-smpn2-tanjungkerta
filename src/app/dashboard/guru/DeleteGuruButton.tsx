...
import { deleteGuru } from '@/app/actions/guru.actions'

export default function DeleteGuruButton({ id, nama }: { id: string, nama: string }) {
            ...
            <div className="p-6 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-2">
                  Apakah Anda yakin ingin menghapus data <span className="font-semibold text-slate-700">"{nama}"</span> dari daftar Guru/Tendik?
                </p>
              </div>
            </div>
