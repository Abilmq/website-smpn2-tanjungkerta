...
import { toggleGuruAktif } from '@/app/actions/guru.actions'

export default function ToggleGuruAktifButton({ id, aktif }: { id: string, aktif: boolean }) {
  const [isPending, startTransition] = useTransition()

  return (
    <button
      onClick={() => startTransition(async () => {
        await toggleGuruAktif(id, aktif)
      })}
      disabled={isPending}
