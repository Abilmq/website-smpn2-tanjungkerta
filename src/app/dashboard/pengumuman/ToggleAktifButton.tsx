...
import { togglePengumumanAktif } from '@/app/actions/pengumuman.actions'

export default function ToggleAktifButton({ id, aktif }: { id: string, aktif: boolean }) {
  const [isPending, startTransition] = useTransition()

  return (
    <button
      onClick={() => startTransition(async () => { await togglePengumumanAktif(id, aktif) })}
      disabled={isPending}
