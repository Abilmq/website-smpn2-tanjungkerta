...
import { deletePengumuman } from '@/app/actions/pengumuman.actions'
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="p-6 text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900">Hapus Pengumuman?</h3>
                <p className="text-sm text-slate-500 mt-2">
                  Apakah Anda yakin ingin menghapus pengumuman <span className="font-semibold text-slate-700">"{judul}"</span>? Tindakan ini tidak dapat dibatalkan.
                </p>
              </div>
            </div>
